    ...
    <div className='cart-item'>
        ...
        <div className='cart-btn-c'>
            <div className='d-flex align-items-center cart-btn-quantity'>
                ...
                <button type='button' className='btn btn-light' onClick={()=> dispatch(increment(id))} style={{border:'1px solid #000', marginRight:'5px'}}>+</button>
                <button type='button' className='btn btn-light' onClick={()=> dispatch(decrement(id))} style={{border:'1px solid #000'}} >-</button>
            </div>
